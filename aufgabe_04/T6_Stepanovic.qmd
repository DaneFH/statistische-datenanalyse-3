...
predict(modell, newdata = gosser, interval = "confidence")
```
Der beobachtete Wert liegt bei 43 kcal/100 ml. Das Modell sagt ca. 44,5 kcal voraus. Gösser Märzen liegt im erwarteten Bereich und zeigt kein auffälliges Kalorienverhalten.
